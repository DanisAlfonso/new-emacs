...
prepended to the element after the #+HEADER: tag."
  ...
  (add-to-list 'org-file-apps
               '("\\.\\(x?html?\\|pdf\\)\\'"
                 .
                 (lambda (file _link)
                   (danis-browse-url-of-file (browse-url-file-url file)))))
...
(when (and (fboundp 'sqlite-available-p) (sqlite-available-p))
  (use-package org-roam
    :diminish
    :functions danis-browse-url org-roam-db-autosync-mode
    ...
    :init
    (setq org-roam-directory danis-org-directory
          org-roam-node-display-template (concat "${title:*} " (propertize "${tags:10}" 'face 'org-tag))
          org-roam-graph-viewer #'danis-browse-url)
    :config
  ...
  (use-package org-roam-ui
    ...
    :init (setq org-roam-ui-browser-function #'danis-browse-url)))
