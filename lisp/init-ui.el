...
;; Title
(setq frame-title-format '("Danis Emacs - %b")
...
(if (danis-compatible-theme-p danis-theme)
    (progn
      ...
      (use-package solaire-mode
        :functions (danis-compatible-theme-p refresh-ns-appearance)
        :commands solaire-global-mode
        :init (solaire-global-mode 1))

      ;; Excellent themes
      (use-package doom-themes
        :functions danis-load-theme doom-themes-visual-bell-config
...
;; Ligatures support
(unless danis-prettify-symbols-alist
