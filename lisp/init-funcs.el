...
(defun danis-browse-url (url)
  "Open URL using a configurable method.
See `browse-url' for more details."
  (interactive)
  (if (xwidget-workable-p)
      (danis-webkit-browse-url url t)
    (browse-url url)))

(defun danis-browse-url-of-file (file)
...
`browse-url' function then run `browse-url-of-file-hook'."
  (interactive)
  (if (xwidget-workable-p)
      (danis-webkit-browse-url (browse-url-file-url file) t)
...
(defun browse-homepage ()
  "Browse the Github page of Danis Emacs."
  (interactive)
...
if NO-SAVE is nil.  This function updates `danis-package-archives'."
  (interactive
   (list
    (intern
...
;; Update
(defun update-config ()
  "Update Danis Emacs configurations to the latest version."
  (interactive)
  ...
  (pcase theme
    ...
    ('system
     ...
     (use-package auto-dark
       ...
       :init
       (setq auto-dark-themes `((,(alist-get 'dark danis-system-themes))
                                (,(alist-get 'light danis-system-themes))))
